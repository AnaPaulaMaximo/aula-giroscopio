...
return (
  <View style={styles.container}>
    ...
    {/* Exibindo valores formatados com fallback para 0 */}
    <Text style={styles.text}>
      x: {((x ?? 0).toFixed(1) === "-0.0" ? "0.0" : (x ?? 0).toFixed(1))}
    </Text>
    <Text style={styles.text}>
      y: {((y ?? 0).toFixed(1) === "-0.0" ? "0.0" : (y ?? 0).toFixed(1))}
    </Text>
    <Text style={styles.text}>
      z: {((z ?? 0).toFixed(1) === "-0.0" ? "0.0" : (z ?? 0).toFixed(1))}
    </Text>
  </View>
);
